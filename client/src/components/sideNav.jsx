        ...
        if (this.props.sideNavFlag) {
            return (<CSSTransition
                ...
                <div className = 'side-nav'>
                    <div className = "side-nav-spacing btn btn-primary" onClick = {this.props.clickHandler}>Hide Side Nav</div>
                    {this.props.seeds.map((seed, index) => {
                        return (
                            <div className = "side-nav-spacing btn btn-primary" key = {index} onClick = {() => {
